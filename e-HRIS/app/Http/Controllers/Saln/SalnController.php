    ...
    public function add_saln(Request $request)
    {
        ...
        if($request->save_or_update === 'Save'){
            ...
            $add_saln = [
                ...
                'biafc_has_business_interest' => $request->biafc_has_business_interest,
                'ritgs_has_gov_serv_relative' => $request->ritgs_has_gov_serv_relative,
            ...
            __notification_set(1, "SALN Added!", "SALN added successfully!");
            add_log('saln', $saln_id,'SALN added Successfully!');
    ...
    public function load_details(Request $request){
        ...
        if($get_saln->get_personal_prop()->exists()){
            foreach ($get_saln->get_personal_prop as $personal_prop) {
                ...
                <td><input name="table_personal_prop_year_acquired[]" type="number"  min="0" class="form-control" placeholder="YEAR ACQUIRED" value="'.$personal_prop->year_acquired.'"></td>
        ...
        if($get_saln->get_real_prop()->exists()){
            foreach ($get_saln->get_real_prop as $real_prop) {
                ...
                <td><input name="modal_asset_year[]" type="number" class="form-control"  placeholder="Year" value="'.$real_prop->year.'"></td>
