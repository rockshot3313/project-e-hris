...
class ProfileController extends Controller
{
    ...
    public function print_pds($user_id)
    {
        ...
        $work_experience = pds_work_exp::where('user_id', $_user_id)->where('active', true)->skip(0)->take(22)->orderBy('to', 'DESC')->get();

        $voluntary_work = pds_voluntary_work::where('user_id', $_user_id)->where('active', true)->skip(0)->take(5)->orderBy('to', 'DESC')->get();

        $learning_dev = pds_learning_development::where('user_id', $_user_id)->where('active', true)->skip(0)->take(21)->orderBy('to', 'DESC')->get();
