...
Route::prefix('IDP')->group(function(){
    ...
    Route::post('/get-pos',[idp::class, 'get_designation_get_position']);
...
Route::prefix("Leave")->group(function(){
    ...
    Route::get('/load_applied_leave_submitted', [LeaveController::class, 'get_employee_details_set_leave'])->name('load_applied_leave_submitted');
    Route::get('/get_employee_details_set_leave/{agency_id}/edit', [LeaveController::class, 'get_employee_details_set_leave'])->name('get_employee_details_set_leave');
