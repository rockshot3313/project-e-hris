            ...
            if(data.length > 0) {
                for(var i=0;i<data.length;i++) {
                    ...
                    //destination
                        ...
                        '<div class="flex items-center whitespace-nowrap text-'+id+'"><div class="w-2 h-2 bg-'+id+' rounded-full mr-3"></div>'+net_worth+'</div>' +
                                ...
                                '<div class="w-8 h-8 rounded-full flex items-center justify-center border dark:border-darkmode-400 ml-2 text-slate-400 zoom-in tooltip dropdown" title="More Action">'+
                                    ...
                                    '<div class="dropdown-menu w-40">'+
                                        '<div class="dropdown-content">'+
                                            ...
                                            '<a  href="javascript:;" target="_blank" href="/saln/print/saln/'+id+'/dl" class="dropdown-item" data-sln-id="'+id+'"> <i class="fa fa-download w-4 h-4 mr-2 text-success"></i> Download </a>'+
...
function add_row_asset(){
    var tr='<tr class="hover:bg-gray-200">'+
                ...
                '<td><input name="modal_asset_year[]" type="number" class="form-control" value="2023" placeholder="Year"></td>'+
...
function add_row_pp(){
    var tr='<tr class="hover:bg-gray-200">'+
                ...
                '<td><input name="table_personal_prop_year_acquired[]" type="number" value="2023" min="0" class="form-control" placeholder="YEAR ACQUIRED"></td>'+
    ...
    $.ajax({
        ...
        success:function (response) {
            ...
            console.log(data);
                ...
                __notif_show( 1, "Success", "SALN "+add+" successfully!");
                load_saln_data();
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if(data['get_saln']['biafc_has_business_interest'] == 1){
                $("#biafc_has_business_interest").attr('checked', 'checked');
            ...
            if(data['get_saln']['ritgs_has_gov_serv_relative'] == 1){
                $("#ritgs_has_gov_serv_relative").attr('checked', 'checked');
