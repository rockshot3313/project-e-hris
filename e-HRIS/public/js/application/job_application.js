            ...
            if(data.length > 0) {
                for (var i = 0; i < data.length; i++) {
                    ...
                    if (index == "0")
                    {
                        ...
                        Job_opportunities_list(remarks, doc_req, email_through, post_date, close_date, email_address, address);
...
function Job_opportunities_list(remarks, doc_req, email_through, post_date, close_date, email_address, address){
    ...
    let html_data =
        ...
        "<div class='accordion-item mb-5'>"+
            ...
            "</div>"+
            "<div class='mt-5'>" +
                "<label class='text-sm font-medium leading-none font-bold'>HRMO III</label>"+
            "</div>"+
            "<div>"+
...
$("body").on('click', '#job_list_number', function (){
    ...
    // $(this).addClass('job-btn-active').siblings().removeClass('job-btn-active').addClass('job-btn-inactive');
    ...
    // Job_opportunities_list(assign_agency, remarks, doc_req);
