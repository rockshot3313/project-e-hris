							...
							/***/
								...
								cd = '' +
						                '<tr >' +
                                            ...
                                            '<input class="form-check-input user_check[]" name="user_check" type="checkbox" value="'+id+'" id="user_check[]" >'+
                                            ...
                                            '<td class="w-auto">' +
                                                '<div class="flex justify-center items-center" role="group" aria-label="Basic outlined example">'+
                                                    '<button type="button" class="btn btn-outline-secondary flex items-center mr-2 user_priv_table_updated" data-tw-toggle="modal" data-tw-target="#user_priv_modal"><i class="fa fa-edit text-success"></i></button>'+
                                                '</div>'+
							...
							/***/
								...
								cd = '' +
						                '<tr >' +
						                    ...
						                    '<td>' +
                                                '<input class="form-check-input cb_read[]" name="cb_read" type="checkbox" value="'+module_id+'" id="cb_read[]" '+  ( read == 1 ? " checked" : "") +'>'+
						                    '</td>' +

                                            '<td>' +
                                            '<input class="form-check-input cb_write[]" name="cb_write" type="checkbox" value="'+module_id+'" id="cb_write[]" '+  ( write == 1 ? " checked" : "") +'>'+

						                    '</td>' +


                                            '<td>' +
                                            '<input class="form-check-input cb_create[]" name="cb_create" type="checkbox" value="'+module_id+'" id="cb_create[]" '+  ( create == 1 ? " checked" : "") +'>'+

						                    '</td>' +


                                            '<td>' +
                                            '<input class="form-check-input cb_dtdelete[]" name="cb_dtdelete" type="checkbox" value="'+module_id+'" id="cb_dtdelete[]" '+  ( dtdelete == 1 ? " checked" : "") +'>'+

						                    '</td>' +


                                            '<td>' +
                                            '<input class="form-check-input cb_dtimport[]" name="cb_dtimport" type="checkbox" value="'+module_id+'" id="cb_dtimport[]" '+  ( dtimport == 1 ? " checked" : "") +'>'+

						                    '</td>' +


                                            '<td>' +
                                            '<input class="form-check-input cb_dtexport[]" name="cb_dtexport" type="checkbox" value="'+module_id+'" id="cb_dtexport[]" '+  ( dtexport == 1 ? " checked" : "") +'>'+
						                    '</td>' +


                                            '<td>' +
                                            '<input class="form-check-input cb_dtprint[]" name="cb_dtprint" type="checkbox" value="'+module_id+'" id="cb_dtprint[]" '+  ( dtprint == 1 ? " checked" : "") +'>'+
						                    '</td>' +
