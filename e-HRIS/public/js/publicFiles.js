                ...
                for(var i=0;i<data.length;i++) {
                    ...
                    cd = '' +
                        ...
                        '<td class="desc flex items-center justify-center">' +
                            '<a id="btn_public_message" href="javascript:;" data-trk-no="'+track_number+'" data-doc-message="'+desc+'" class="tooltip" title="'+tool_tip_title+'"> <div class="flex items-center whitespace-nowrap "><i class="w-5 h-5 pt-3 pb-3 '+message_icon+'"></i></div></a>' +
                        '</td>' +
