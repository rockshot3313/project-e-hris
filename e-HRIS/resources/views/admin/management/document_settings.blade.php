...
@section('content')
    ...
    @include('Documents.Modals.create_DocType')
    @include('Documents.Modals.update_DocType')

    @include('Documents.Modals.create_DocLevel')
    @include('Documents.Modals.update_DocLevel')
@endsection
@section('scripts')
