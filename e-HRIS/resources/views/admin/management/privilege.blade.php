...
<div class="intro-y flex flex-col sm:flex-row items-center mt-8">
    ...
    <div class="w-full sm:w-auto flex">
        <button type="button" class="btn btn-primary shadow-md mr-2 user_priv_table_updated" data-tw-toggle="modal" data-tw-target="#user_priv_modal"> <i class="w-4 h-4 mr-2" data-lucide="settings"></i> Add Privileges </button>
...
<div class="intro-y box p-5 mt-5">
    <div class="overflow-x-auto scrollbar-hidden pb-10">
        <table id="dt__users" class="table table-report -mt-2 table-hover">
            <thead>
            <tr>
                <th  class="text-center whitespace-nowrap "><div class="flex"> <input class="form-check-input selectall" type="checkbox" value="" ></div></th>
