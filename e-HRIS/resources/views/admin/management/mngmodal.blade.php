                        ...
                        <div class="overflow-x-auto">
                            <table id="dt__user_priv" class="table table-report  table-hover">
                                ...
                                <tr>
                                    ...
                                    <th class="text-center"><div class="flex"><input class="form-check-input selectall_Read" name="selectall_Read" type="checkbox" value="" ><span > Read</span> </div></th>
                                    <th class="text-center"><div class="flex"><input class="form-check-input selectall_Write" type="checkbox" value="" ><span > Write</span> </div></th>
                                    <th class="text-center"><div class="flex"><input class="form-check-input selectall_Create" type="checkbox" value="" ><span > Create</span> </div></th>
                                    <th class="text-center"><div class="flex"><input class="form-check-input selectall_Delete" type="checkbox" value="" ><span > Delete</span> </div></th>
                                    <th class="text-center"><div class="flex"><input class="form-check-input selectall_Import" type="checkbox" value="" ><span > Import</span> </div></th>
                                    <th class="text-center"><div class="flex"><input class="form-check-input selectall_Export" type="checkbox" value="" ><span > Export</span> </div></th>
                                    <th class="text-center"><div class="flex"><input class="form-check-input selectall_Print" type="checkbox" value="" ><span > Print</span> </div></th>
                                </tr>
                                </thead>
                                <tbody>
                                ...
                                @forelse (getModule() as $module)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <input class="form-check-input cb_important" name="cb_important" type="checkbox" value="{{ $module->id }}" id="cb_important" {{ ( $module->important == 1 ? ' checked' : '') }}>
                                        </td>
