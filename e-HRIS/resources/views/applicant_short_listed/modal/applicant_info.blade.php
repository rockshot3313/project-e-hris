                        ...
                        <div class="flex items-start px-5 pt-5">
                            <div class="w-full flex flex-col lg:flex-row items-center">
                                ...
                                <div class="lg:ml-4 text-center lg:text-left mt-3 lg:mt-0">
                                    <strong><label id="applicant_name" class="font-medium"></label></strong>
                                    <div class="text-slate-500 text-xs mt-0.5"><label id="applied_position"></label></div>
                                    <div class="text-slate-500 text-xs mt-0.5"><label id="assign_aggency"></label></div>
                                </div>
                            </div>
                        </div>
                        <div class="text-center lg:text-left p-5">
                            <div><strong>Comment</strong></div>
                            <div class="mt-2"><labe id="coments"></labe></div>
                            <div class="flex items-center justify-center lg:justify-start text-slate-500 mt-5">
                                <i class="fa fa-calendar-days"></i> <span class="ml-2 font-small">Applied Date:</span> <span class="ml-2"><label id="date-applied" class="font-medium"></label></span>
                            </div>
                            <div class="flex items-center justify-center lg:justify-start text-slate-500 mt-1">
                                <i class="fa fa-calendar-days"></i> <span class="ml-2">Approval Date:</span><span class="ml-2"><label id="approval-date" class="font-medium"></label></span>
                            </div>
                            <div class="flex items-center justify-center lg:justify-start text-slate-500 mt-1">
                                <i class="fa fa-user"></i> <span class="ml-2">Approved By:</span> <label id="approve_by"class="ml-2 font-medium"></label>
                            </div>
                            <div class="flex items-center justify-center lg:justify-start text-slate-500 mt-1">
                            ...
                            <div id="faq-accordion-2" class="accordion accordion-boxed mt-3">
                                <div class="accordion-item">
                                    ...
                                    <div id="faq-accordion-collapse-5" class="accordion-collapse collapse show" aria-labelledby="faq-accordion-content-5" data-tw-parent="#faq-accordion-2">
                                        <div class="mt-2">
                                            <textarea id="notes" onchange="" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border" placeholder="Enter notes" ></textarea>
                                        </div>
                                        <div class="mt-2">
                                        ...
                                        <div class=" relative w-70 mx-auto mt-2">
                                            ...
                                            <div class="absolute rounded-l w-10 h-10 flex items-center justify-center bg-slate-100 border text-slate-500 dark:bg-darkmode-700 dark:border-darkmode-800 dark:text-slate-400 mt-2"> <i data-lucide="calendar" class="w-4 h-4"></i> </div> <input id="appointment_shcedule" type="text" class="datepicker form-control pl-12 h-10 mt-2" data-single-mode="true">
                                        </div>
                                        <div class="mt-2">
