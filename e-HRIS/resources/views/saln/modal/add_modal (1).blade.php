                                    ...
                                    <div class="col-span-12 mt-4 sm:col-span-12">
                                        ...
                                        <div class="sm:grid grid-cols-3 gap-2">
                                            <div class="input-group">
                                                <input id="modal_declarant_firstname" type="text" class="form-control" placeholder="First Name">
                                            </div>
                                            <div class="input-group mt-2 sm:mt-0">
                                                <input id="modal_declarant_lastname" type="text" class="form-control" placeholder="Last Name">
                                            </div>
                                            <div class="input-group mt-2 sm:mt-0">
                                                <input id="modal_declarant_middlename" type="text" class="form-control" placeholder="Middle Name">
                                            </div>
                                        </div>
                                    </div>
