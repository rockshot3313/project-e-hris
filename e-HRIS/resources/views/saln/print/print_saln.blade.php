    ...
    <body>
        ...
        <main>
                ...
                <div style="text-align: center" class = "information">
                    <div style="font-family:'Bookman Old'; font-size:70%;margin-top: -20px"><label style="font-family:'Bookman Old';"> As of ________________________________</label></div>
                    ...
                    <table width = "100%">
                        ...
                        <table width = "100%" style="text-align: left">
                            <tr>
                                <td >
                                    <table width="350px" style="text-align: left; margin: -18px 0px -10px 0px; table-layout: fixed ; border-spacing: 20px 5px;">
                                        <tr>
                                            <td style="font-family:'Bookman Old'; font-size:120%;">Government Issued ID: </td>
                                            <td style=" border-bottom: 1pt solid black;">
