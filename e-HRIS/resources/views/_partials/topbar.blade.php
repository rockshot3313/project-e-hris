            ...
            <div class="intro-x dropdown mr-auto sm:mr-6 __notification">
                ...
                <div class="notification-content pt-2 dropdown-menu">
                    ...
                    @forelse (loadNotification() as $notification )
                            ...
                            @if ( $notification->subject == 'hiring' && $notification->purpose == 'inform' )

                                @if(check_panels($notification->target_id,$notification->subject_id))

                                    <div class="cursor-pointer relative flex items-center mt-2 ">
                                        <div class="w-12 h-12 flex-none image-fit mr-1">
                                            {!!get_profile_image($notification->target_id)!!}
