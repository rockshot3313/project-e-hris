            ...
            <br>
                <table style="width: 100%">
                    <tr style="text-align: center">
                        <td>
                            <span> This is a (DMS) generated report:</span> <strong>{{ $current_date }}</strong>
                        </td>
                        <td>
                            <span> </span>
                        </td>
                ...
                <div   class = "information">
                    <table style="width: 100%">
                        <tr>
                            ...
                            <td style="width: 50%">
                                <div style="text-align: center">Date: {{ date('F j, Y', strtotime($get_to->date)); }}</div>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td>
                                <div style="padding: 5px">Station: {{ $get_to->station }}</div>
                                <div style="padding: 5px">Departure Date: {{ date('F j, Y', strtotime($get_to->departure_date)); }}</div>
                            </td>

                            <td>
                                <div style="padding: 5px">Destination: {{ $get_to->destination }}</div>
                                <div style="padding: 5px">Return Date: {{ date('F j, Y', strtotime($get_to->return_date)); }}</div>
