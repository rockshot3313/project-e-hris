            ...
            <div class="grid grid-cols-12 gap-6">
                ...
                <div class="intro-y box col-span-12 lg:col-span-12">
                    <div class="flex items-center px-5 py-5 sm:py-3 border-b border-slate-200/60 dark:border-darkmode-400">
                        ...
                        <a id="btn_print_PDS" target="_blank" href="/my/print/pds/{{Crypt::encrypt(Auth::user()->id)}}" class="btn btn-primary w-32 mr-2 mb-2"> <i data-lucide="printer" class="w-4 h-4 mr-2"></i> Print PDS </a>
                    </div>
...
{{--                                @endforelse--}}
                        ...
                        <div class="input-form col-span-12 lg:col-span-6">
                            ...
                            <input id="res_sub" type="text" style="text-transform:uppercase" name="res_sub" class="form-control" placeholder="Street" minlength="2" autocomplete="off">
                        </div>
                ...
                <div class="intro-y box col-span-12 lg:col-span-6">
                    ...
                    <div class="p-5 grid grid-cols-12 gap-6">
                        ...
                        <div class="input-form col-span-12 lg:col-span-6">
                            <label for="validation-form-1" class="form-label w-full flex flex-col sm:flex-row"> Subdivision/Village </label>
                            <input id="per_sub" type="text" style="text-transform:uppercase" name="per_sub" class="form-control" placeholder="Street" minlength="2" autocomplete="off">
                        </div>
                    ...
                    <div id="family_bg_div"  class="p-5 grid grid-cols-12 gap-6">
                        ...
                        <div class="grid col-span-6 lg:col-span-12 gap-4">
                            ...
                            <div class="input-form col-span-12 lg:col-span-6">
                                ...
                                <input id="fam_mother_maiden_name" style="text-transform:uppercase" type="text" name="fam_mother_maiden_name" class="form-control" placeholder="Father's Surname" minlength="2" autocomplete="off">
                            </div>
                            <div class="input-form col-span-6 lg:col-span-6">
                                <label for="validation-form-1" class="form-label w-full flex flex-col sm:flex-row"> Surname </label>
