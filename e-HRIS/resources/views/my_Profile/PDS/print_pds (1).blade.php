...
<main >
    ...
    <table  class="my-table">
        <tr>
            <td rowspan="2"  bgcolor="#a9a9a9" style="width: 100%;" class="border-bottom border-top border-left border-right pl-1">
    ...
    <table class="personal-info-table">
        <tr>
            <td class="border-left border-right border-top column-color pl-1" style="width: 20%;">
            ...
            <td colspan="2" class="border-box pl-1" style="width: 80%">
        ...
        <tr>
            ...
            <td class="border-box pl-1 column-color" style="
            width: 30%">
        ...
        <tr>
            <td class="border-left pl-1 border-right border-bottom-bold column-color" style="width: 20%">
            ...
            <td colspan="2" class="border-bottom-bold border-left border-right border-top pl-1" style="width: 80%">
            ...
            <td style="width: 100%;">
                <div style="margin: -1px">
                    <table class="my-table">
                        ...
                        <tr>
                            <td style="width: 20%; height: 12px;" class="border-right border-left border-bottom arial column-color pl-1">
                            ...
                            <td class="border-right-bold border-bottom pl-1" style="width: 25%">
                                <div style="margin-top: 1px; text-align: left"><label class="arial text-8px tex-uppercase" style="font-weight: bold;">@if($pds->dateofbirth){{ $pds->dateofbirth }} @else N/A @endif</label></div>
                            </td>
                            ...
                            <td style="width: 35%" class="border-left border-right pl-1">
                        ...
                        <tr>
                            ...
                            <td class="border-right-bold border-bottom pl-1" style="width: 25%">
                                <div style="margin-top: 1px; text-align: left"><label class="arial text-8px tex-uppercase" style="font-weight: bold;">@if($pds->placeofbirth){{ $pds->placeofbirth }} @else N/A @endif</label></div>
                            </td>
                        ...
                        <tr>
                            ...
                            <td style="width: 35%" class="border-left border-top border-right pl-1">
                                <div class="arial font-normal text-8px text-center">@if($pds->dual_citizenship_country){{ $pds->dual_citizenship_country }} @else N/A @endif</div>
                            </td>
                ...
                <div style="margin: -1px">
                    <table class="my-table">
                        ...
                        <tr>
                            ...
                            <td style="width: 40%" class="border-left border-top border-right">
                                <div style="margin: -1px">
                                    <table class="my-table" style="text-align:center">
                                        ...
                                        <tr>
                                            @if($res_address)
                                                ...
                                                <td class="border-bottom-custom" style="width:50%"><small style="font-weight:bold;font-size:9px" class="arial tex-uppercase">@if($res_address->get_brgy) @if($res_address->get_brgy->brgyDesc){{ $res_address->get_brgy->brgyDesc }} @else N/A @endif @endif</small></td>
                                            @else
                                                <td class="border-bottom-custom" style="width:50%"><small style="font-weight:bold;font-size:9px" class="arial tex-uppercase">N/A</small></td>
                                                <td class="border-bottom-custom" style="width:50%"><small style="font-weight:bold;font-size:9px" class="arial tex-uppercase">N/A</small></td>
                                            @endif
                            ...
                            <td style="width: 40%" class="border-left border-top border-right">
                                <div style="margin: -1px">
                                    <table class="my-table" style="text-align:center">
                                        <tr >
                                            @if($res_address)
                                                <td class="border-bottom-custom" style="width:50%"><small style="font-weight:bold;font-size:9px" class="arial tex-uppercase">@if($res_address->get_city_mun) @if($res_address->get_city_mun->citymunDesc){{ $res_address->get_city_mun->citymunDesc }} @else N/A @endif @endif</small></td>
                                                <td class="border-bottom-custom" style="width:50%"><small style="font-weight:bold;font-size:9px" class="arial tex-uppercase">@if($res_address->get_province) @if($res_address->get_province->provDesc){{ $res_address->get_province->provDesc }} @else N/A @endif @endif</small></td>
                                            @else
                                                <td class="border-bottom-custom" style="width:50%"><small style="font-weight:bold;font-size:9px" class="arial tex-uppercase">N/A</small></td>
                                                <td class="border-bottom-custom" style="width:50%"><small style="font-weight:bold;font-size:9px" class="arial tex-uppercase">N/A</small></td>
                                            @endif
                        ...
                        <tr>
                            ...
                            <td style="width: 40%" class="border-left border-right text-center">
                                <div class="arial font-normal text-8px font-bold">@if($res_address->zip_code){{ $res_address->zip_code }} @else N/A @endif</div>
                            </td>
                        </tr>
                        <!-- END: 8. WEIGHT (kg) -->
                        ...
                        <tr>
                            ...
                            <td style="width: 40%" class="border-left border-right">
                                <div style="margin: -1px">
                                    <table class="my-table" style="text-align:center">
                                        <tr>
                                            @if($per_address)
                                                ...
                                                <td class="border-bottom-custom" style="width:50%"><small style="font-weight:bold;font-size:9px" class="arial tex-uppercase">@if($per_address->get_brgy) @if($per_address->get_brgy->brgyDesc){{ $per_address->get_brgy->brgyDesc }} @else N/A @endif @endif</small></td>
                                            @else
                                                <td class="border-bottom-custom" style="width:50%"><small style="font-weight:bold;font-size:9px" class="arial tex-uppercase">N/A</small></td>
                                                <td class="border-bottom-custom" style="width:50%"><small style="font-weight:bold;font-size:9px" class="arial tex-uppercase">N/A</small></td>
                                            @endif
                            ...
                            <td style="width: 40%" class="border-left border-top border-right">
                                <div style="margin: -1px">
                                    <table class="my-table" style="text-align:center">
                                        <tr>
                                            @if($per_address)
                                                <td class="border-bottom-custom" style="width:50%"><small style="font-weight:bold;font-size:9px" class="arial tex-uppercase">@if($per_address->get_city_mun) @if($per_address->get_city_mun->citymunDesc){{ $per_address->get_city_mun->citymunDesc }} @else N/A @endif @endif</small></td>
                                                <td class="border-bottom-custom" style="width:50%"><small style="font-weight:bold;font-size:9px" class="arial tex-uppercase">@if($per_address->get_province) @if($per_address->get_province->provDesc){{ $per_address->get_province->provDesc }} @else N/A @endif @endif</small></td>
                                            @else
                                                <td class="border-bottom-custom" style="width:50%"><small style="font-weight:bold;font-size:9px" class="arial tex-uppercase">N/A</small></td>
                                                <td class="border-bottom-custom" style="width:50%"><small style="font-weight:bold;font-size:9px" class="arial tex-uppercase">N/A</small></td>
                                            @endif
                        ...
                        <tr>
                            ...
                            <td style="width: 40%" class="border-left border-top border-right text-center">
                                <div class="arial font-normal text-8px font-bold">@if($per_address->zip_code){{ $per_address->zip_code }} @else N/A @endif</div>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td style="width: 40%" class="border-left border-top border-right text-center">
                                <div class="arial font-normal text-8px font-bold">@if($pds->mobile){{ $pds->mobile }} @else N/A @endif</div>
                            </td>
                        </tr>
                        <!-- END:   14. TIN NO. -->
                        ...
                        <tr>
                            <td style="width: 20%; height: 12px;" class="border-right border-left arial column-color pl-1">
    ...
    <table  class="my-table">
        <tr>
            <td rowspan="2"  bgcolor="#a9a9a9" style="width: 100%" class="border-top-bold border-right border-left pl-1">
    ...
    <table class="my-table border-box">
        <tr>
            <td style="width: 60%;" class="border-top-bold border-left border-right">
                <div style="margin-top: -2px; margin-left: -1px; margin-right: -1px; margin-bottom: -3px">
                    <table class="my-table">

                        <!-- BEGIN: SPOUSE -->
                        <tr>
                            <td style="width: 33%; height: 12px" class="border-bottom border-right arial column-color">
                                <div class="text-center arial text-8px font-normal">22. SPOUSE'S SURNAME</div>
                            </td>
                            <td colspan="2" style="height: 14px" class="border-bottom px-1 arial">
                                <div class="arial text-8px font-bold">@if($pds->family_bg) @if($pds->family_bg->spouse_surname) {{ $pds->family_bg->spouse_surname }}@else N/A @endif @endif</div>
                            </td>
                        </tr>

                        <tr>
                            <td style="width: 33%; height: 14px" class="border-bottom border-right px-1 arial column-color">
                                <div class="text-center arial text-8px font-normal">FIRST NAME</div>
                            </td>

                            <td style="width: 42%; height: 12px;" class="border-bottom arial px-1">
                                <div class="arial text-8px font-bold">@if($pds->family_bg) @if($pds->family_bg->spouse_firstname) {{ $pds->family_bg->spouse_firstname }}@else N/A @endif @endif </div>
                            </td>

                            <td style="width: 25%; height: 12px; font-size: 7px" class="border-bottom border-left arial column-color">
                                <div style="font-size: 7px" class="text-center arial font-normal">NAME EXTENSION (JR., SR)</div>
                                <div style="font-size: 7px; margin-top: -1px" class="text-center arial font-bold">@if($pds->family_bg) @if($pds->family_bg->spouse_ext) {{ $pds->family_bg->spouse_ext }}@else N/A @endif @endif </div>
                            </td>
                        </tr>

                        <tr>
                            <td style="width: 33%; height: 14px" class="border-bottom border-right px-1 arial column-color">
                                <div class="text-center arial text-8px font-normal">MIDDLE NAME</div>
                            </td>

                            <td colspan="2" style="height: 12px;" class="border-bottom border-top arial px-1">
                                <div class="arial text-8px font-bold">@if($pds->family_bg) @if($pds->family_bg->spouse_mi) {{ $pds->family_bg->spouse_mi }}@else N/A @endif @endif</div>
                            </td>
                        </tr>

                        <tr>
                            <td style="width: 33%; height: 14px" class="border-bottom border-right px-1 arial column-color">
                                <div class="text-center arial text-8px font-normal">OCCUPATION</div>
                            </td>

                            <td colspan="2" style="height: 12px;" class="border-bottom border-top arial px-1">
                                <div class="arial text-8px font-bold">@if($pds->family_bg) @if($pds->family_bg->occupation) {{ $pds->family_bg->occupation }}@else N/A @endif @endif</div>
                            </td>
                        ...
                        <tr>
                            <td style="width: 33%; height: 14px" class="border-bottom border-right px-1 arial column-color">
                                <div class="text-center arial text-8px font-normal">EMPLOYER/BUSINESS NAME</div>
                            </td>

                            <td colspan="2" style="height: 12px;" class="border-bottom border-top arial px-1">
                                <div class="arial text-8px font-bold">@if($pds->family_bg) @if($pds->family_bg->employer_name) {{ $pds->family_bg->employer_name }}@else N/A @endif @endif</div>
                            </td>
                        ...
                        <tr>
                            <td style="width: 33%; height: 14px" class="border-bottom border-right px-1 arial column-color">
                                <div class="text-center arial text-8px font-normal">BUSINESS ADDRESS</div>
                            </td>

                            <td colspan="2" style="height: 12px;" class="border-bottom border-top arial px-1">
                                <div class="arial text-8px font-bold">@if($pds->family_bg) @if($pds->family_bg->business_address) {{ $pds->family_bg->business_address }}@else N/A @endif @endif</div>
                            </td>
                        </tr>

                        <tr>
                            <td style="width: 33%; height: 14px" class="border-bottom border-right px-1 arial column-color">
                                <div class="text-center arial text-8px font-normal">TELEPHONE NO.</div>
                            </td>

                            <td colspan="2" style="height: 12px;" class="border-bottom border-top arial px-1">
                                <div class="arial text-8px font-bold">@if($pds->family_bg) @if($pds->family_bg->tel_no) {{ $pds->family_bg->tel_no }}@else N/A @endif @endif</div>
                            </td>
                        </tr>
                        <!-- END: SPOUSE -->
                        ...
                        <!-- BEGIN: FATHER -->
                        <tr>
                            <td style="width: 33%; height: 14px" class="border-bottom border-right arial column-color">
                                <div class="text-center arial text-8px font-normal">24. FATHER'S SURNAME</div>
                            </td>
                            <td colspan="2" style="height: 14px" class="border-bottom px-1 arial px-1">
                                <div class="arial text-8px font-bold">@if($pds->family_bg) @if($pds->family_bg->father_surname) {{ $pds->family_bg->father_surname }}@else N/A @endif @endif</div>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td style="width: 42%; height: 12px;" class="border-bottom arial px-1">
                                <div class="arial text-8px font-bold">@if($pds->family_bg) @if($pds->family_bg->father_firstname) {{ $pds->family_bg->father_firstname }}@else N/A @endif @endif</div>
                            </td>
                            <td style="width: 25%; height: 12px; font-size: 7px" class="border-bottom border-left arial column-color">
                                <div style="font-size: 7px" class="text-center arial font-normal">NAME EXTENSION (JR., SR)</div>
                                <div style="font-size: 7px; margin-top: -1px" class="text-center arial font-bold">@if($pds->family_bg) @if($pds->family_bg->father_ext) {{ $pds->family_bg->father_ext }}@else N/A @endif @endif</div>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td colspan="2" style="height: 12px;" class="border-bottom border-top arial px-1">
                                <div class="arial text-8px font-bold">@if($pds->family_bg) @if($pds->family_bg->father_mi) {{ $pds->family_bg->father_mi }}@else N/A @endif @endif</div>
                            </td>
                        ...
                        <tr>
                            <td style="width: 33%; height: 14px" class="border-bottom border-right arial column-color">
                                <div class="text-center arial text-8px font-normal">25. MOTHER'S MAIDEN NAME</div>
                            </td>
                            <td colspan="2" style="height: 14px" class="border-bottom px-1 arial">
                                <div class="arial text-8px font-bold">@if($pds->family_bg) @if($pds->family_bg->mother_maidenname) {{ $pds->family_bg->mother_maidenname }}@else N/A @endif @endif</div>
                            </td>
                        </tr>

                        <tr>
                            <td style="width: 33%; height: 14px" class="border-bottom border-right arial column-color">
                                <div class="text-center arial text-8px font-normal">SURNAME</div>
                            </td>
                            <td colspan="2" style="height: 14px" class="border-bottom px-1 arial">
                                <div class="arial text-8px font-bold">@if($pds->family_bg) @if($pds->family_bg->mother_surname) {{ $pds->family_bg->mother_surname }}@else N/A @endif @endif</div>
                            </td>
                        </tr>

                        <tr>
                            <td style="width: 33%; height: 14px" class="border-right arial column-color">
                                <div class="text-center arial text-8px font-normal">MIDDLE NAME</div>
                            </td>
                            <td colspan="2" style="height: 14px" class="px-1 arial">
                                <div class="arial text-8px font-bold">@if($pds->family_bg) @if($pds->family_bg->mother_mi) {{ $pds->family_bg->mother_mi }}@else N/A @endif @endif</div>
                            </td>
                        </tr>
                        <!-- END: MOTHER -->
            ...
            <!-- BEGIN: NAME OF CHILDREN -->
                <td style="width: 40%;" class="border-top-bold border-left border-right">
                <div style="margin-top: -1px; margin-left: -1px; margin-right: -1px; margin-bottom: -3px">
                    <table class="my-table">
                        <tr>
                            <td style="width: 70%; height: 12px" class="border-bottom border-right column-color">
                                <div style="font-size: 8px" class="text-center arial font-normal"> 23. NAME of CHILDREN  (Write full name and list all)</div>
                            </td>
                            <td style="width: 30%; height: 12px" class="border-bottom column-color">
                                <div>
                        ...
                        @foreach($child as $ch)
                            ...
                            @if($child)
                                ...
                                @endphp
                                <tr>
                                    <td style="width: 70%; height: 12px" class="border-right border-bottom">
                                        <div class="text-center arial text-7px-new font-bold">{{ $ch->name }}</div>
                                    </td>
                                    <td style="width: 30%; height: 12px" class="border-bottom">
                                        <div class="text-center arial text-8px font-bold">{{ Carbon\Carbon::parse($ch->birth_date)->format('m/d/Y') }}</div>
                                    </td>
                                </tr>

                            @else
                                @for ($ch_ = 1; $ch_ <= $work_exp_row_max; $ch_++)
                                    <tr>
                                        <td style="width: 70%; height: 12px" class="border-right border-bottom">
                                            <div class="text-center arial text-8px font-normal hidden">N/A</div>
                                        </td>
                                        <td style="width: 30%; height: 12px" class="border-bottom">
                                            <div class="text-center arial text-8px font-normal hidden">N/A</div>
                                        </td>
                        ...
                        @if($child)
                            @php
                                $ch_added_ = $child_row_max - $child_row_current;
                            @endphp

                            @for ($ch_1 = 1; $ch_1 <= $ch_added_; $ch_1++)
                                <tr>
                                    <td style="width: 70%; height: 12px" class="border-right border-bottom">
                                        <div class="text-center arial text-8px font-normal hidden">N/A</div>
                                    </td>
    ...
    <table  class="my-table">
        <tr>
            <td rowspan="2"  bgcolor="#a9a9a9" style="width: 100%" class="border-top-bold border-left border-right px-1">
    ...
    <table id="_this_table" class="my-table">
        ...
        <tr class="column-color border-top-bold">
            <th rowspan="2" class="arial text-8px border-box font-normal"             style="width: 20%"><div >26. LEVEL</div></th>
            <th rowspan="2" class="text-center arial text-8px border-box font-normal" style="width: 25%"><div > NAME OF SCHOOL <div class="mt-1 text-7px">(Write in full)</div></div></th>
            <th rowspan="2" class="text-center arial text-8px border-box font-normal" style="width: 15%"><div> <div> BASIC EDUCATION/</div> <div>DEGREE/COURSE</div> <div style="margin-top: -5px" class="text-7px">(Write in full)</div></div></th>
            <th colspan="2" class="text-center arial text-8px border-box font-normal" style="width: 10%"><div > PERIOD OF ATTENDANCE</div></th>
            <th rowspan="2" class="text-center arial text-8px border-box font-normal" style="width: 10%"><div > HIGHEST LEVELS/UNITS EARNED <div class="mt-1 text-7px">(if not graduated)</div></div></th>
            <th rowspan="2" class="text-center arial text-8px border-box font-normal" style="width:  5%"><div > YEAR GRADUATED</div></th>
            <th rowspan="2" class="text-center arial text-8px border-box font-normal" style="width: 15%"><div > SCHOLARSHIP/ ACADEMIC HONORS RECEIVED</div></th>
        </tr>
        <tr>
        ...
        @foreach($educational_background as $educ)
            ...
            @if($educ)
                ...
                <tr>
                    <td style="width: 20%; height: 26px" class="px-1 border-box arial text-8-new-px font-normal column-color">{{ $educ->level }}</td>
                    <td style="width: 25%; height: 26px" class="px-1 border-box arial text-8-new-px font-normal">{{ $educ->school_name }}</td>
                    <td style="width: 15%; height: 26px" class="px-1 border-box arial text-8-new-px font-normal">{{ $educ->degreee_course }}</td>
                    <td style="width: 5%;  height: 26px" class="px-1 border-box arial text-8-new-px font-normal">{{ $educ->attendance_from }}</td>
                    <td style="width: 5%;  height: 26px" class="px-1 border-box arial text-8-new-px font-normal">{{ $educ->attendance_to }}</td>
                    <td style="width: 10%; height: 26px" class="px-1 border-box arial text-8-new-px font-normal">{{ $educ->units_earned }}</td>
                    <td style="width: 5%;  height: 26px" class="px-1 border-box arial text-8-new-px font-normal">{{ $educ->year_graduated }}</td>
                    <td style="width: 15%; height: 26px" class="px-1 border-box arial text-8-new-px font-normal">{{ $educ->acad_honors }}</td>
                </tr>
            @else
                @for ($educ_ = 1; $educ_ <= $work_exp_row_max; $educ_++)
                    <tr>
                        <td style="width: 20%; height: 26px" class="px-1 border-box arial text-8-new-px font-normal column-color"></td>
                        <td style="width: 25%; height: 26px" class="px-1 border-box arial text-8-new-px font-normal"></td>
                        <td style="width: 15%; height: 26px" class="px-1 border-box arial text-8-new-px font-normal"></td>
                        <td style="width: 5%;  height: 26px" class="px-1 border-box arial text-8-new-px font-normal"></td>
                        <td style="width: 5%;  height: 26px" class="px-1 border-box arial text-8-new-px font-normal"></td>
                        <td style="width: 10%; height: 26px" class="px-1 border-box arial text-8-new-px font-normal"></td>
                        <td style="width: 5%;  height: 26px" class="px-1 border-box arial text-8-new-px font-normal"></td>
                        <td style="width: 15%; height: 26px" class="px-1 border-box arial text-8-new-px font-normal"></td>
                    </tr>
                @endfor
        ...
        @if($educ)
            @php
                $educ_added_ = $educ_row_max - $educ_row_current;
            @endphp

            @for ($educ_1 = 1; $educ_1 <= $educ_added_; $educ_1++)
                <tr>
                    <td style="width: 20%; height: 26px" class="px-1 border-box arial text-8-new-px font-normal column-color"></td>
                    <td style="width: 25%; height: 26px" class="px-1 border-box arial text-8-new-px font-normal"></td>
                    <td style="width: 15%; height: 26px" class="px-1 border-box arial text-8-new-px font-normal"></td>
        ...
        <tr>
            <td colspan="8" style="text-align: center" class="border-top-bold border-bottom-bold border-right border-left column-color"><label style="font-style: italic; color: red" class="arial text-10px">(Continue on separate sheet if necessary)</label></td>
        </tr>

        <tr>
            <td colspan="" style="height: 24px" class="border-right-bold border-left arial text-9px font-bold text-center column-color ">SIGNATURE</td>
            ...
            <td colspan="3" style="height: 24px" class="border-right arial text-9px "></td>
        </tr>
        <tr>
            <td colspan="8" style="text-align: right" class="arial text-8px border-top-bold border-bottom-bold border-left border-right">CS FORM 212 (Revised 2017), Page 1 of 4</td>
        </tr>
    ...
    <table  class="my-table">
        <tr>
            <td rowspan="2"  bgcolor="#a9a9a9" style="width: 100%" class="border-right border-left border-bottom-bold border-top-bold px-1">
    ...
    <table class="my-table">
        <thead class="column-color">
            ...
            <tr>
                <td rowspan="2" colspan="2" class="px-1 border-box">
                ...
                <td rowspan="2" colspan="1" class="border-box" >
                ...
                <td rowspan="2" class="border-box text-center"><div class="arial text-8px font-normal">PLACE OF EXAMINATION / CONFERMENT</div></td>
                <td colspan="2" class="border-box"><div class="arial text-8px font-normal text-center">LICENSE (if applicable)</div></td>
            </tr>

            <tr>
                <td class="text-center arial text-9px border-box column-color font-normal">NUMBER</td>
                <td class="text-center arial text-9px border-box column-color font-normal">
                    <div>Date of</div>
                    <div>Validity</div>
                </td>
            </tr>
        ...
        @foreach($civil_service as $cs)
            ...
            @if($civil_service)
                ...
                <tr>
                    <td colspan="2" class="border-box h-20"><label class="px-1 arial text-8-new-px font-normal">{{ $cs->eligibility_type }}</label></td>
                    <td class="border-box h-20"><label class="px-1 arial text-8-new-px font-normal">{{ $cs->rating }}</label></td>
                    <td class="border-box h-20"><label class="px-1 arial text-8-new-px font-normal">{{ $cs->date_examination }}</label></td>
                    <td class="border-box h-20"><label class="px-1 arial text-8-new-px font-normal">{{ $cs->place_examination }}</label></td>
                    <td class="border-box h-20"><label class="px-1 arial text-8-new-px font-normal">{{ $cs->license_number }}</label></td>
                    <td class="border-box h-20"><label class="px-1 arial text-8-new-px font-normal">{{ $cs->license_validity }}</label></td>
                </tr>
                @else
                    @for ($cs = 1; $cs <= $cs_row_max; $cs++)
                        <tr>
                            <td colspan="2" class="border-box h-20"><label style="display: none" class="px-1 arial text-8-new-px font-normal">N/A</label></td>
                            <td class="border-box h-20"><label class="px-1 arial text-8-new-px font-normal"></label></td>
                            <td class="border-box h-20"><label class="px-1 arial text-8-new-px font-normal"></label></td>
                            <td class="border-box h-20"><label class="px-1 arial text-8-new-px font-normal"></label></td>
                            <td class="border-box h-20"><label class="px-1 arial text-8-new-px font-normal"></label></td>
                            <td class="border-box h-20"><label class="px-1 arial text-8-new-px font-normal"></label></td>
        ...
        <!-- END: 1 -->
            ...
            <tr>
                <td colspan="7" class="border-box column-color" style="text-align: center; height: 15px"><label style="font-style: italic; color: red" class="arial text-10px">(Continue on separate sheet if necessary)</label></td>
            </tr>
    ...
    <table  class="my-table">
        <tr>
            <td bgcolor="#a9a9a9" style="width: 100%; height: 40px" class="border-right border-left border-bottom-bold border-top-bold">
    ...
    <table class="my-table">
        <thead>
            <tr class="column-color">
                ...
                <td class="border-box" colspan="2" style="width: 12%">
                ...
                <td class="border-box text-center" rowspan="2" style="width: 5%">
            ...
            <tr class="column-color">
                <td style="width: 6%" class="border-box"><div class="arial text-8px font-normal text-center">From</td>
        ...
        <tbody>
            ...
            @foreach($work_experience as $exp)
                ...
                @if($work_experience)
                    ...
                    <tr>
                        <td style="width: 6%"  class="border-box h-20 px-1 arial text-8-new-px font-normal">{{ $exp->from }}</td>
                        <td style="width: 6%"  class="border-box h-20 px-1 arial text-8-new-px font-normal">{{ $exp->to }}</td>
                        <td style="width: 30%" class="border-box h-20 px-1 arial text-8-new-px font-normal">{{ $exp->position_title }}</td>
                        <td style="width: 25%" class="border-box h-20 px-1 arial text-8-new-px font-normal">{{ $exp->dept_agency_office }}</td>
                        <td style="width: 10%" class="border-box h-20 px-1 arial text-8-new-px font-normal text-center">{{ $exp->monthly_sal }}</td>
                        <td style="width: 8%"  class="border-box h-20 px-1 arial text-8-new-px font-normal text-center">{{ $exp->sal_grade }}</td>
                        <td style="width: 10%" class="border-box h-20 px-1 arial text-8-new-px font-normal">{{ $exp->appointment_status }}</td>
                        <td style="width: 5%"  class="border-box h-20 px-1 arial text-8-new-px font-normal text-center">{{ $exp->gvt_service }}</td>
                    </tr>

                @else
                    @for ($work_exp = 1; $work_exp <= $work_exp_row_max; $work_exp++)
                        <tr>
                            <td style="width: 6%"  class="border-box h-20 px-1 arial text-8-new-px font-normal"></td>
                            <td style="width: 6%"  class="border-box h-20 px-1 arial text-8-new-px font-normal"></td>
                            <td style="width: 30%" class="border-box h-20 px-1 arial text-8-new-px font-normal"></td>
                            <td style="width: 25%" class="border-box h-20 px-1 arial text-8-new-px font-normal"></td>
                            <td style="width: 10%" class="border-box h-20 px-1 arial text-8-new-px font-normal"></td>
                            <td style="width: 8%"  class="border-box h-20 px-1 arial text-8-new-px font-normal"></td>
                            <td style="width: 10%" class="border-box h-20 px-1 arial text-8-new-px font-normal"></td>
                            <td style="width: 5%"  class="border-box h-20 px-1 arial text-8-new-px font-normal"></td>
                        </tr>
                    @endfor
                @endif
            @endforeach
            ...
            <tr>
                <td style="text-align: center;" colspan="8" class="border-top-bold border-bottom-bold border-right border-left column-color"><label style="font-style: italic; color: red" class="arial text-10px">(Continue on separate sheet if necessary)</label></td>
            </tr>
            <tr class="border-bottom-bold border-right border-left">
                <td colspan="2" style="height: 30px" class="border-right-bold arial text-9px font-bold text-center column-color">SIGNATURE</td>
                <td colspan="2" style="height: 30px" class="border-right-bold arial text-9px "></td>
                <td colspan=""  style="height: 30px" class="border-rightarial text-9px  font-bold text-center column-color">DATE</td>
                <td colspan="3" style="height: 30px" class="border-right-bold arial text-9px "></td>
            </tr>

            <tr>
                <td colspan="8" style="text-align: right;" class="arial text-8px border-right border-left border-bottom-bold">CS FORM 212 (Revised 2017), Page 2 of 4</td>
            </tr>
        </tbody>
    </table>
    ...
    <table  class="my-table">
        <tr>
            <td bgcolor="#a9a9a9" style="width: 100%; height: 20px" class="border-box">
    ...
    <table class="voluntary-work-table">
        <tr class="column-color">
            <td class="border-box" rowspan="2" style="text-align:center"><div class="arial text-8px font-normal">29. <label style="padding-left: 20px; text-align:center">NAME & ADDRESS OF ORGANIZATION (Write in full)</label></div></td>
            <td class="border-box" colspan="2" style="text-align:center"><div class="arial text-8px font-normal"><label style="padding-left: 20px; text-align:center">INCLUSIVE DATES (mm/dd/yyyy)</label></div></td>
            <td class="border-box" rowspan="2"><div class="arial text-8px font-normal"><label style="padding-left: 20px; text-align:center">NUMBER OF HOURS</label></div></td>
            <td class="border-box" rowspan="2"><div class="arial text-8px font-normal"><label style="padding-left: 20px; text-align:center">POSITION / NATURE OF WORK</label></div></td>
        </tr>

        <tr class="column-color">
            <td  class="border-box"><div class="arial text-8px font-normal"><label style="padding-left: 20px; text-align:center">From</label></div></td>
            <td  class="border-box"><div class="arial text-8px font-normal"><label style="padding-left: 20px; text-align:center">To</label></div></td>
        </tr>
        ...
        @foreach($voluntary_work as $vol_work)
            ...
            @if($voluntary_work)
                ...
                <tr>
                    <td class="border-box px-1"><div class="arial text-10px font-bold">{{ $vol_work->org_name_address }}</div></td>
                    <td class="border-box px-1"><div class="arial text-10px font-bold">{{ $vol_work->from }}</div></td>
                    <td class="border-box px-1"><div class="arial text-10px font-bold">{{ $vol_work->to }}</div></td>
                    <td class="border-box px-1"><div class="arial text-10px font-bold">{{ $vol_work->hours_number }}</div></td>
                    <td class="border-box px-1"><div class="arial text-10px font-bold">{{ $vol_work->work_position_nature }}</div></td>
                </tr>
            @else
                @for ($vol = 1; $vol <= $vol_row_max; $vol++)
                    <tr>
                        <td class="border-box px-1"><div class="arial text-10px font-bold">{{ $vol }}</div></td>
                        <td class="border-box px-1"><div class="arial text-10px font-bold"></div></td>
                        <td class="border-box px-1"><div class="arial text-10px font-bold"></div></td>
                        <td class="border-box px-1"><div class="arial text-10px font-bold"></div></td>
                        <td class="border-box px-1"><div class="arial text-10px font-bold"></div></td>
                    </tr>
        ...
        @endif
            ...
            <tr>
                <td colspan="5" class="border-box column-color" style="text-align: center; height: 10px"><label style="font-style: italic; color: red" class="arial text-10px">(Continue on separate sheet if necessary)</label></td>
            </tr>
    ...
    <table  class="my-table">
        <tr>
            <td bgcolor="#a9a9a9" style="width: 100%; height: 40px" class="border-box">
    ...
    <table class="ld-table">
        ...
        <thead>
            <tr class="column-color">
            <td class="border-box" rowspan="2"><div class="arial text-8px font-normal">30. <label>TITLE OF LEARNING AND DEVELOPMENT INTERVENTIONS/TRAINING PROGRAMS  (Write in full)</label></div></td>
            <td colspan="2" class="border-box"><div class="arial text-8px font-normal text-center"><label>INCLUSIVE DATES (mm/dd/yyyy) </label></div></td>
            <td class="border-box" rowspan="2"><div class="arial text-8px font-normal text-center"><label>NUMBER OF HOURS</label></div></td>
            <td class="border-box" rowspan="2"><div class="arial text-8px font-normal text-center"><label>Type of LD ( Managerial/ Supervisory/Technical/etc) </label></div></td>
            <td class="border-box" rowspan="2"><div class="arial text-8px font-normal text-center"><label>CONDUCTED/ SPONSORED BY (Write in full)</label></div></td>
            </tr>

            <tr class="column-color">
                <td  class="border-box"><div class="arial text-8px font-normal text-center"><label>From</label></div></td>
                <td  class="border-box"><div class="arial text-8px font-normal text-center"><label>To</label></div></td>
            </tr>
        ...
        @foreach($learning_dev as $l_dev)
            ...
            @if($learning_dev)
                ...
                @endphp
                <tr>
                    <td  class="border-box px-1"><label class="text-10px arial font-bold">{{ $l_dev->learning_dev_title }}</label></td>
                    <td  class="border-box px-1"><label class="text-10px arial font-bold">{{ $l_dev->from }}</label></td>
                    <td  class="border-box px-1"><label class="text-10px arial font-bold">{{ $l_dev->to }}</label></td>
                    <td  class="border-box px-1"><label class="text-10px arial font-bold">{{ $l_dev->hours_number }}</label></td>
                    <td  class="border-box px-1"><label class="text-10px arial font-bold">{{ $l_dev->learning_dev_type }}</label></td>
                    <td  class="border-box px-1"><label class="text-10px arial font-bold">{{ $l_dev->conducted_sponsored }}</label></td>
                </tr>
            @else
                @for ($ld_empty = 1; $ld_empty <= $ld_row_max; $ld_empty++)
                    <tr>
                        <td  class="border-box px-1"><label class="text-10px arial font-bold"></label></td>
                        <td  class="border-box px-1"><label class="text-10px arial font-bold"></label></td>
                        <td  class="border-box px-1"><label class="text-10px arial font-bold"></label></td>
                        <td  class="border-box px-1"><label class="text-10px arial font-bold"></label></td>
                        <td  class="border-box px-1"><label class="text-10px arial font-bold"></label></td>
        ...
        @endif
            ...
            <tr>
                <td colspan="6" class="border-box column-color" style="text-align: center; height: 10px"><label style="font-style: italic; color: red" class="arial text-10px">(Continue on separate sheet if necessary)</label></td>
            </tr>
    </table>
    <!-- BEGIN: VII  LEARNING AND DEVELOPMENT (L&D) INTERVENTIONS/TRAINING PROGRAMS ATTENDED -->
    ...
    <table  class="my-table">
        <tr>
            <td rowspan="2"  bgcolor="#a9a9a9" style="width: 100%" class="border-box">
    ...
    <table class="ld-table">
        <thead>
            <tr class="column-color">
                <td colspan="3" class="border-box" ><div class="arial text-8px font-normal">31. <label style="padding-left: 20px; text-align:center">SPECIAL SKILLS and HOBBIES</label></div></td>
                <td colspan="3" class="border-box" ><div class="arial text-8px font-normal">32. <label style="padding-left: 20px; text-align:center">NON-ACADEMIC DISTINCTIONS / RECOGNITION (Write in full)</label></div></td>
                <td colspan="2" class="border-box"><div class="arial text-8px font-normal">33. <label style="padding-left: 20px; text-align:center">MEMBERSHIP IN ASSOCIATION/ORGANIZATION (Write in full)</label></div></td>
            </tr>
        </thead>
        ...
        @foreach($special_skills as $skills)
            ...
            @if($special_skills)
                ...
                @endphp
                    ...
                    <tr>
                        <td colspan="3"  class="border-box"><label class="text-10px arial font-bold">@if($skills->special_skills) {{ $skills->special_skills }} @else N/A @endif</label></td>
                        <td colspan="3"  class="border-box"><label class="text-10px arial font-bold">@if($skills->distinctions) {{ $skills->distinctions }} @else N/A @endif</label></td>
                        <td colspan="2" class="border-box"><label class="text-10px arial font-bold">@if($skills->org_membership) {{ $skills->org_membership }} @else N/A @endif</label></td>
                    </tr>
            @else
                @for ($skill_empty = 1; $skill_empty <= $skills_row_max; $skill_empty++)
                    <tr>
                        <td colspan="3"  class="border-box h-15"><label class="text-10px arial font-bold"></label></td>
                        <td colspan="3"  class="border-box h-15"><label class="text-10px arial font-bold"></label></td>
                        <td colspan="2" class="border-box h-15"><label class="text-10px arial font-bold"></label></td>
                    </tr>
                @endfor
            @endif
        @endforeach
        ...
        <tr>
            <td colspan="8" class="border-box column-color" style="text-align: center; height: 10px"><label style="font-style: italic; color: red" class="arial text-10px">(Continue on separate sheet if necessary)</label></td>
        </tr>

        <tr>
            <td class="border-box arial text-9px font-bold text-center column-color">SIGNATURE</td>
            <td colspan="4" class="border-box arial text-9px"></td>
            <td class="border-box arial text-9px font-bold text-center column-color">DATE</td>
            <td colspan="2" class="border-box arial text-9px"></td>
        </tr>

        <tr>
            <td colspan="8" style="text-align: right; height: 10px" class="border-box arial text-8px">CS FORM 212 (Revised 2017), Page 3 of 4</td>
        </tr>
    </table>
            ...
            <td style="padding:10px; width: 30%" class="border-left border-bottom border-right">
                ...
                @elseif($other_info->other_info_37 == "0")
                    <div >
                        <input  type="checkbox" style="margin-bottom: -7px" id="dual_check"> <label class="ml-1">YES</label>
                        <input checked type="checkbox" style="margin-bottom: -7px; margin-left: 21px" id="dual_check"><label class="ml-1">NO</label>
                        <div style="margin-top: 5px">If YES, give details:_____________________________________</div>
                        <label>_____________________________________________________</label>
                    </div>
                @else
                    <div >
                        <input  type="checkbox" style="margin-bottom: -7px" id="dual_check"> <label class="ml-1">YES</label>
        ...
        <tr>
            ...
            @else
                <tr>
                    ...
                    <td style="padding:10px;  width: 30%" class="border-left border-right">
                        <div style="margin-top:-20px">If YES, please Specify ID No:_________</div>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td style="padding:10px;  width: 30%" class="border-left border-right">
                        <div style="margin-top:-20px">______________________________________</div>
                    </td>
                </tr>
            @endif
...
{{--                        <div style="margin-top:-20px">If YES, please Specify ID No:<span style="text-decoration: underline" class="ml-1">{{ $other_info->other_info_40_b_details }}</span></div>--}}
{{--                    @else--}}
{{--                        <div style="margin-top:-20px">If YES, please Specify ID No:__________</div>--}}
{{--                    @endif--}}
{{--                </td>--}}
{{--            </tr>--}}
            ...
            <td style="width: 80%" class="border-box">
                <div style="margin: -1px">
                    ...
                    <!-- END: NUMBER 41. -->
                        ...
                        <!-- BEGIN: NUMBER 42. -->
                        <tr>
                            <td  colspan="3" class="column-color">
...
{{--                                <img src="{{ $image }}" width="100%" height="100%" alt="Profile Picture">--}}
    ...
    <table class="my-table">
        <tr>
            <td colspan="8" style="text-align: right" class="border-box arial text-10px">CS FORM 212 (Revised 2017), Page 4 of 4</td>
        </tr>
    </table>
