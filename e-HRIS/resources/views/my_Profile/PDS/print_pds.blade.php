...
<main >
    ...
    <table  class="my-table">
        <tr>
            <td rowspan="2"  bgcolor="#a9a9a9" style="width: 100%;" class="border-bottom-bold border-top-bold border-left border-right pl-1">
    ...
    <table class="personal-info-table">
        <tr>
            <td class="border-left border-right border-top-bold column-color pl-1" style="width: 20%;">
            ...
            <td colspan="2" class="border-left border-right border-bottom border-top-bold pl-1" style="width: 80%">
        ...
        <tr>
            ...
            <!-- BEGIN: NAME OF CHILDREN -->
                ...
                <div style="margin-top: -1px; margin-left: -1px; margin-right: -1px; margin-bottom: -3px">
                    <table class="my-table">
                        <tr>
                            <td style="width: 70%; height: 12px" class="border-bottom border-right border-left column-color">
    ...
    <table class="my-table">
        ...
        <tbody>
            ...
            <tr class="border-bottom-bold border-right border-left">
                <td colspan="2" style="height: 20px" class="border-right-bold arial text-9px font-bold text-center column-color">SIGNATURE</td>
                <td colspan="2" style="height: 20px" class="border-right-bold arial text-9px "></td>
                <td colspan=""  style="height: 20px" class="border-right-bold arial text-9px  font-bold text-center column-color">DATE</td>
                <td colspan="3" style="height: 20px" class="border-right-bold arial text-9px "></td>
            </tr>
    ...
    <table  class="my-table">
        <tr>
            <td bgcolor="#a9a9a9" style="width: 100%; height: 20px" class="border-left border-right border-bottom-bold border-top-bold">
    ...
    <table class="voluntary-work-table">
        <tr class="column-color">
            ...
            <td class="border-box px-1" rowspan="2" style="width: 35%"  >
        ...
        @foreach($special_skills as $skills)
            ...
            @if($special_skills)
                ...
                @endphp
                    ...
                    <tr>
                        <td colspan="3"  class="border-box"><label class="text-10px arial ">@if($skills->special_skills) {{ $skills->special_skills }} @else N/A @endif</label></td>
                        <td colspan="3"  class="border-box"><label class="text-10px arial ">@if($skills->distinctions) {{ $skills->distinctions }} @else N/A @endif</label></td>
                        <td colspan="2" class="border-box"><label class="text-10px arial ">@if($skills->org_membership) {{ $skills->org_membership }} @else N/A @endif</label></td>
                    </tr>
            @else
